...
public class charta {
	...
	JLabel l4,l5,l6,l7,l8,l9,l10,l11,l12,l13;
	JLabel l14,l15,l16,l17;
	JTextField t1;
	JButton b1,b2;
	int a;int j=0;
     charta(String fullname)
     {
	  ...
	  f.add(cb);
   	 ...
   	 // cb5.setBounds(160,120,30,30);
   	  ...
   	  l10 = new JLabel("Bus_id");
   	  l10.setBounds(30,120,80,30);
   	  f.add(l10);
   	  t1 = new JTextField();
   	  t1.setBounds(80,120,200,30);
   	  f.add(t1);
   	  b1 = new JButton("ok");
   	  b1.setBounds(140,170,60,30);
   	  f.add(b1);
    	 try {
	  ...
	  ActionListener chart = new ActionListener() {
		  public void actionPerformed(ActionEvent e) {
			  ...
			  l10.setBounds(200,60,80,30);
			  l11 = new JLabel("conducter:");
			  l11.setBounds(200,90,80,30);
			  l12 =new JLabel();
			  l12.setBounds(280,60,80,30);
			  l13 =new JLabel();
			  l13.setBounds(280,90,80,30);
			  f1.add(l12);f1.add(l13);
			  f1.add(l10);f1.add(l11);
			 ...
			 b2 = new JButton("ok");
			  ...
			  f1.add(l17);
			  date = daer+"-"+mony+"-"+yey;
			  String bus = t1.getText();
			  int a = Integer.parseInt(bus);
			  try {
					Class.forName("org.postgresql.Driver");}
				catch(ClassNotFoundException ch) {
					System.out.println("class not found");
						...
						Connection con = DriverManager.getConnection ( "jdbc:postgresql://localhost:5432/bus_management", "postgres","sohan2003");
						 ...
						 String sql = "select * from bus where bid=?";
						  ...
						  while(result.next()) {
							   ...
							   String conduct = result.getString("conduct");
							   l12.setText(driver);
							   l13.setText(conduct);
							   System.out.println(driver+" "+conduct);
						  }
